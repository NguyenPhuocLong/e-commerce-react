    ...
    return pages.map((page, index) => (
      <li key={index}>
        {page === "..." ? (
          ...
          <a
            href="#"
            className={`text-theme-sm hover:bg-brand-500/[0.08] hover:text-brand-500 dark:hover:text-brand-500 flex h-10 w-10 items-center justify-center rounded-lg font-medium ${
              currentPage === page
